...
link = input("Вставьте ссылку на исполнителя на сервисе Yandex Music: ")

try:
    accession = requests.get(link)
    ...
    logger.error(f"No connection adapters were found for {link}. Use the right schema"
